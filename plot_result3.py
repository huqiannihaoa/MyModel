...
names = ['YOLOv5m','YOLOv5s','YOLOv5n','YOLOv5s6','YOLOv5m6','YOLOv5-Transformer','YOLOv5_Conv-SPD_DAFPN','YOLOv6','YOLOv7','YOLOv8n','YOLOv8-AFPN']
# names = ['mymodel','mymodel02-eciou']
plt.figure(figsize=(10, 10))

plt.subplot(2, 2, 1)
for i in names:
    data = pd.read_csv(f'runs/train/xr/human/{i}/results.csv')
...
# plt.legend()
# names1 = ['yolov5(ECIoU)','yolov5(EIoU)']
# names2 = ['yolov5+Conv-SPD+DAFPN(EIoU)','yolov5+Conv-SPD+DAFPN(CIoU)','yolov5+Conv-SPD+DAFPN(ECIoU)']
plt.subplot(1, 1, 1)
for i in names:
    data = pd.read_csv(f'runs/train/xr/human/{i}/results.csv')
...
plt.title('val/box_loss',size=23)

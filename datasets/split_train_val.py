...
def get_opt():
    ...
    parser.add_argument('--xml_path', default='./datasets/train/VOCdevkit/VOC2007/Annotations/',
                        type=str, help='input xml file ')
    # parser.add_argument('--xml_path', default='./datasets/val/VOCdevkit/VOC2007/Annotations/',
    #                     type=str, help='input xml file ')
    # parser.add_argument('--xml_path', default='./datasets/train2012/VOCdevkit/VOC2012/Annotations/',
    #                     type=str, help='input xml file ')
    parser.add_argument('--txt_path', default="./datasets/train/VOCdevkit/VOC2007/ImageSets/Main/",
                        type=str, help='output txt file')
    # parser.add_argument('--txt_path', default="./datasets/val/VOCdevkit/VOC2007/ImageSets/Main/",
    #                     type=str, help='output txt file')
    # parser.add_argument('--txt_path', default="./datasets/train2012/VOCdevkit/VOC2012/ImageSets/Main/",
    #                     type=str, help='output txt file')
